...
.controller('adminPurchaseOrderCtrl',  function($base64,$ionicPlatform,$scope,$ionicModal, $state, $http, $rootScope, $ionicLoading, $timeout,$ionicPopup,$filter){
...
.controller('allPartyLedgerCtrl', function($base64,$ionicPlatform,$scope, $state, $http, $rootScope, $ionicLoading, $timeout,$ionicPopup,$filter,$cordovaSQLite) {
...
.controller('singlePartyCtrl', function($base64,$ionicPlatform,$scope,$ionicModal, $state, $http, $rootScope, $ionicLoading, $timeout,$ionicPopup,$filter,$cordovaSQLite) {
...
.controller('lcPartyCtrl', function($base64,$ionicPlatform,$scope,$ionicModal, $state, $http, $rootScope, $ionicLoading, $timeout,$ionicPopup,$filter,$cordovaSQLite){
...
.controller('allCustomerLedgerCtrl', function($base64,$ionicPlatform,$scope,$ionicModal, $state, $http, $rootScope, $ionicLoading, $timeout,$ionicPopup,$filter,$cordovaSQLite){
...
.controller('singleCustomerCtrl', function($base64,$ionicPlatform,$scope,$ionicModal, $state, $http, $rootScope, $ionicLoading, $timeout,$ionicPopup,$filter,$cordovaSQLite){
...
.controller('cashPaymentDeptwiseCtrl', function($base64,$ionicPlatform,$scope,$ionicModal, $state, $http, $rootScope, $ionicLoading, $timeout,$ionicPopup,$filter,$cordovaSQLite){
...
.controller('cashPaymentGroupWiseCtrl', function($base64,$ionicPlatform,$scope,$ionicModal, $state, $http, $rootScope, $ionicLoading, $timeout,$ionicPopup,$filter){
...
.controller('clientPurchaseOrderCtrl', function($base64,$ionicPlatform,$scope,$ionicModal, $state, $http, $rootScope, $ionicLoading, $timeout,$ionicPopup,$filter){
 $scope.paymentTypeSelect = { select: "-Select One-" };
 $scope.bankNameSelect = { select: "-Select One-" };
 $scope.measureTypeSelect = { select: "-Select One-" };
...
.controller('clientPurchaseOrderStatusCtrl', function($base64,$ionicPlatform,$scope,$ionicModal, $state, $http, $rootScope, $ionicLoading, $timeout,$ionicPopup,$filter){
...
.controller('clientPurchaseOrderStatusDetailsCtrl', function($base64,$ionicPlatform,$scope,$ionicModal, $state, $http, $rootScope, $ionicLoading, $timeout,$ionicPopup,$filter){
...
.controller('clientViewStatementCtrl', function($base64,$ionicPlatform,$scope,$ionicModal, $state, $http, $rootScope, $ionicLoading, $timeout,$ionicPopup,$filter){
...
.controller('userAcceptActionCtrl', function($base64,$ionicPlatform,$scope,$ionicModal, $state, $http, $rootScope, $ionicLoading, $timeout,$ionicPopup,$filter){
